    ...
    return render_template_string('''
        ...
        <head>
            ...
            <style>
                ...
                .download-link { display: block; margin-top: 20px; color: #fff; text-decoration: none; background: #333; padding: 10px; border-radius: 15px; font-weight: bold; }
            </style>
        </head>
        <body>
            <div class="card">
                ...
                {% if v_id and v_id != "error" %}
                    <div style="margin-top:25px;">
                        ...
                        <p style="font-size:12px; color:#888;">شغال دلوقتي في الخلفية.. استمتع 😎</p>
                        <a href="https://www.y2mate.com/youtube/{{ v_id }}" target="_blank" class="download-link">تحميل MP3 مباشر ⬇️</a>
                    </div>
                {% endif %}
            </div>
