...
class CalcApp(App):
    ...
    def on_button_press(self, instance):
        ...
        if button_text == "C": self.solution.text = ""
        else:
            if current and (self.last_was_operator and button_text in self.operators): return
            new_text = current + button_text
            self.solution.text = new_text
        self.last_button = instance
        self.last_was_operator = self.last_button.text in self.operators
